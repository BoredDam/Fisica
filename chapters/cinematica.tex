...
Nel moto circolare uniforme l’accelerazione è dovuta esclusivamente al cambiamento di direzione della velocità.  
Consideriamo due istanti molto vicini $t_1$ e $t_2$ e le corrispondenti velocità $\vec{v}_1$ e $\vec{v}_2$, di uguale modulo $v$ ma direzione diversa.
...
Dal triangolo delle velocità si ricava, per piccoli angoli $\Delta\theta$:
\[
...
Sostituendo:
\[
|\vec{a}| = \lim_{\Delta t \to 0} v\,\frac{\Delta\theta}{\Delta t}
\]

Nel limite $\Delta t \to 0$:
\[
|\vec{a}| = v\,\frac{d\theta}{dt} = v\omega
\]

Usando la relazione $v = R\omega$, si ottiene:
\[
\boxed{a_c = R\omega^2 = \frac{v^2}{R}}
\]

L’accelerazione è detta \textbf{centripeta} ed è sempre diretta verso il centro della circonferenza.
